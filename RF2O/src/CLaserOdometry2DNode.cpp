  ...
  CLaserOdometry2D()
{
  ...
  if (init_pose_from_topic != "")
  {
    ...
    ROS_INFO("Initial Pose Obtained...");    
  }
  else
  {
    ...
    ROS_INFO("NO Initial Pose Obtained...");
  }
...
{
  if(!scan_available()){
    ROS_WARN("CLaserOdometry2DNode::Scan Dropped...");
  ...
  {
    ROS_WARN("CLaserOdometry2DNode::process not success....");
  }
}
